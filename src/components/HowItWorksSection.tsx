...
export const HowItWorksSection: React.FC<HowItWorksSectionProps> = ({ isVisible = true }) => {
  const steps = [
    {
      step: '01',
      title: 'Upload',
    ...
    <div className="w-full mt-6 mb-2">
      <div className="overflow-hidden min-h-0">
        <div 
          ...
          className="w-full pt-6 pb-6 border-t border-b border-neutral-200/60 dark:border-neutral-800/60"
        >
          {/* Section Header */}
