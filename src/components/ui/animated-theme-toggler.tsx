...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "relative flex p-1.5 items-center justify-center text-neutral-800 dark:text-neutral-200 hover:text-neutral-900 dark:hover:text-white active:scale-95 active:opacity-60 transition cursor-pointer focus:outline-none",
        className
      )}
