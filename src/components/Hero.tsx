...
import { FileText, Link as LinkIcon, Image as ImageIcon, FileSpreadsheet, FileStack, Hash } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({ onScanSelect, isHowItWorksVisible = true }) => {
  ...
  return (
    <section className="relative overflow-hidden w-full min-h-[640px] sm:min-h-[680px]">
      {/* Hero Dot Grid Background (contained strictly to the top Hero section, fading out before Threat Scanner) */}
      <HeroDotGrid />

      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-[clamp(130px,12vh,180px)] pb-8 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="hidden lg:block lg:col-span-6 min-h-[460px] sm:min-h-[490px] relative select-none">
            {cards.map((card, idx) => (
              <div
                key={card.id}
        ...
        {/* How It Works Section - Always visible directly on the dashboard/landing page */}
