...
export const Hero: React.FC<HeroProps> = ({ onScanSelect, onSeeHowItWorks, isHowItWorksVisible = false }) => {
  ...
  return (
    <section className="relative overflow-hidden w-full min-h-[640px] sm:min-h-[680px]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-[clamp(130px,12vh,180px)] pb-8 space-y-6">
        ...
        {/* How It Works Section - Expands directly below the See how it works button */}
