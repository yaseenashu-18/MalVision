...
export const Hero: React.FC<HeroProps> = ({ onScanSelect, onSeeHowItWorks, isHowItWorksVisible = false }) => {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 pt-10 pb-4 space-y-4">
      ...
      {/* How It Works Section - Expands directly below the See how it works button with ZERO whitespace gap */}
