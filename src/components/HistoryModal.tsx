...
import { getScanHistory, removeScanFromHistory, clearScanHistory, formatScanDateTime } from '../lib/historyStore';
...
/**
 * Native PDF Generator featuring the official MalVision_logo_pixel_match.svg
        ...
        <div style="margin-bottom: 24px; line-height: 1.8;">
          ...
          <div style="display: flex; gap: 48px; margin-bottom: 16px;">
            <div>
              ...
              <div style="font-size: 13px; font-weight: 600; color: #18181b;">${formatScanDateTime(item.timestamp, item.createdAt)}</div>
            </div>
            <div>
                    ...
                    <div className="flex items-center space-x-2.5 truncate flex-1 min-w-0">
                      ...
                      <div className="truncate min-w-0 flex-1">
                        ...
                        <p className="text-[10px] text-neutral-400 flex items-center space-x-1.5 mt-0.5">
                          ...
                          <span>•</span>
                          <span>{formatScanDateTime(item.timestamp, item.createdAt)}</span>
                        </p>
                      </div>
                    </div>
